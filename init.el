...
(setq emoji '((face-smiling #X1F600 #X1F603 #X1F604 #X1F601 #X1F606 #X1F605 #X1F923 #X1F602 #X1F642 #X1F643 #X1FAE0 #X1F609 #X1F60A #X1F607)
              ...
              (math #X2716 #X2795 #X2796 #X2797 #X1F7F0 #X267E)
...
(defun insert-unicode-emoji-group ()
  (interactive)
  (let* ((emoji-group-name (ido-completing-read
                            "Emoji group: "
                            (mapcar (lambda (x) (symbol-name (car x))) emoji)))
         (emoji-group (assoc (intern emoji-group-name)
                             emoji))
         (emoji-char (unicode-select-char
                      (apply #'unicode-describe-regions
                             (cdr emoji-group)))))
    (insert emoji-char)))
